 ...
 */
class NodeAccessSubscriber implements EventSubscriberInterface, AccessInterface
{
    /**
     * {@inheritdoc}
     */
     ...
     * @return int[][]
     */
    private function collectUserGrants(AccountInterface $user, string $permission = 'view'): array
    {
        $userId = $user->id();
